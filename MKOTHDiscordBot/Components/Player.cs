...
namespace MKOTHDiscordBot
{
    ...
    public class Player
    {
        ...
        public string GetRankFieldString(bool identify = false, bool hideRank = false)
        {
            string name = $"<@!{DiscordId}>" + (identify ? "**\t←**" : "");
        ...
        public static async Task Load()
        {
            try
            {
                ...
                stopwatch.Start();
                var webClients = new System.Net.WebClient[2]
                    .ToList()
                    .ConvertAll(x => new System.Net.WebClient { Encoding = System.Text.Encoding.UTF8 });
